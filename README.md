***本仓库复刻自https://github.com/arunboy/love/tree/master***  
...
**重要的：原项目有评论指出`love.min.js`加密了一段不友好的代码，本项目已解密该文件命名为`T.love.min.js`。鄙人认为所谓“黄”是被劫持导致的，有一定概率触发，但我还是在`index.html`中删除了对应部分**
